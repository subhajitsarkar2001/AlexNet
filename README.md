...
Objective :- This repository  contains  phase 1 part of our project . A group of six members including me  worked in this  project.In this phase  ,all six of us  just performed  a comparative evaluation of six different  CNN architectures where my role was to automatically identify and classify rice leaf diseases from leaf images using a customized AlexNet-based convolutional neural network.
